...
curl --fail --silent --show-error --retry 12 --retry-delay 2 --retry-all-errors "${frontend_url}/api/catalog/categories" >/dev/null

echo "Backend, frontend, and frontend /api proxy (catalog) health checks passed."
